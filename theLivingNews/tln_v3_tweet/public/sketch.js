...
// Setup Function: Setting up
  ...
  function draw() {
    ...
    fill(255);
    stroke(255);
    rect(windowWidth/1.25,windowHeight/16,windowWidth/6.5,windowHeight/4);
    // Draw: Header Title
    fill(100,100,100);
    noStroke();
    textFont(fontEBold);
    textAlign(RIGHT);
    textSize(50);
    text("THE\nLIVING\nNEWS",windowWidth/1.3,windowHeight/13,windowWidth/6.5,windowHeight/4);
    textFont(fontLight);
    textAlign(RIGHT);
    textSize(10);
    text("BY JIBIN VARGHESE",windowWidth/1.32,windowHeight/3.5,windowWidth/6.5,windowHeight/4);

    // Draw: News Header
    fill(255);
    stroke(255);
    rect(windowWidth/1.90,windowHeight/1.65,windowWidth/2.3,windowHeight/3);
    // Draw: News Title
    textFont(fontBold);
    textStyle(NORMAL);
    fill(90,90,90);
    ...
    textAlign(LEFT);
    textSize(24);
    text(n_title+'\n',windowWidth/1.85,windowHeight/1.6,windowWidth/2.7,windowHeight/3);
    // Draw: News Description
    textFont(fontLight);
    fill(80,80,80);
    // textLeading(20);
    textSize(14);
    text(name,windowWidth/1.85,windowHeight/1.4,windowWidth/2.7,windowHeight/3);
    // Draw: News Source
    textFont(fontLItalic);
    textSize(12);
    // textLeading(20);
    text(""+n_author,windowWidth/1.85,windowHeight/1.2,windowWidth/2.7,windowHeight/3);
  ...
  function drawnews(){
        ...
        if (frameCount % 500 == 0) {
         // Saving the Canvas
         saveCanvas('newsimages/tln_image', 'png');
